...
class LLMTest:
    ...
    def rag_generate(self, prompt: str, context: str) -> str:
        ...
        formatted_prompt = f"""Отвечай только на основе представленного контекста, чтобы ответить на вопроc, связанный с конституцией РФ, если в контексте нет информации для ответа, честно скажи об этом.
